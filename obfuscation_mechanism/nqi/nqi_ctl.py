...
class nqi_ctl(object):
    def __init__(self):
        self.generater = nqi()
        self.original_user_data_path = "/home/arc/weichengkun/OBWSPES/data_warehouse/sampled_user_data_original/"
        self.save_path_prefix = "/home/arc/weichengkun/OBWSPES/obfuscation_mechanism/nqi/data/result_data_list/"
        pass
            ...
            for line in fo:
                ...
                if l_data[2][6] in ['3','4'] :
                    ...
                    if query not in train.keys():
                        train[query] = self.generater.generate_fake_query()
                else:
                    query = l_data[1].strip().lower()
                    if query not in test.keys():
                        test[query] = self.generater.generate_fake_query()
        ...
        with open(os.path.join(self.original_user_data_path, file)) as fo:
            for line in fo:
                ...
                if l_data[2][6] in ['3','4'] :
                    ...
                    temp_list.append(self.generater.generate_fake_query())
